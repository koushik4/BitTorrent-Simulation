...
public class PeerProcess1004 {
    ...
    PeerProcess1004(){}
    PeerProcess1004(int PORT, int ID, int numberOfPrefferedNeighbours, int n, int m, int pieceSize) {
        try {
            this.flag = false;
            this.PORT = PORT;
...
//                                System.out.println(socket);
                                ...
                                if(flag){
                                    FileOutputStream fileOutputStream = new FileOutputStream("bitTorrents/peer_1004/tree.jpg");
...
//                                    System.out.println("Request Sent "+remove);
                ...
                } catch (Exception e) {objectInputStream = null;e.printStackTrace();continue;}
            }
        }
...
//        System.out.println(numberOfPrefferedNeighbours+" "+n+" "+m+" "+pieceSize+" "+fileName);
        PeerProcess1004 peerProcess = new PeerProcess1004(1004,id,numberOfPrefferedNeighbours,n,m,pieceSize);
        ...
        for(String peer:peers){
            ...
            if(Integer.parseInt(content[0]) == id){
                ...
                if(content[content.length-1].equals("1")) {
                    int size = peerProcess.processFile("bitTorrents/peer_1004/"+fileName);
