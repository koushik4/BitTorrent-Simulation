...
public class PeerProcess1003 {
    ...
    PeerProcess1003(){}
    PeerProcess1003(int PORT, int ID, int numberOfPrefferedNeighbours, int n, int m, int pieceSize) {
        try {
            this.flag = false;
            this.PORT = PORT;
...
//                                System.out.println(socket);
                                ...
                                if(flag){
                                    ...
                                    FileOutputStream fileOutputStream = new FileOutputStream("bitTorrents/peer_1003/tree.jpg");
...
//                }
//                this.changeNeighbours();
                System.out.println(this.t2.getState());
                this.t2.interrupt();
...
//        System.out.println(numberOfPrefferedNeighbours+" "+n+" "+m+" "+pieceSize+" "+fileName);
        PeerProcess1003 peerProcess = new PeerProcess1003(1003,id,numberOfPrefferedNeighbours,n,m,pieceSize);
        ...
        for(String peer:peers){
            ...
            if(Integer.parseInt(content[0]) == id){
                ...
                if(content[content.length-1].equals("1")) {
                    int size = peerProcess.processFile("bitTorrents/peer_1003/"+fileName);
